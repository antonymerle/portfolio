  ...
  return (
    <div className="bg-slate-800 font-sans w-full">
      ...
      <main className="flex flex-col items-center justify-center w-full">
        ...
        <section
          id="projects"
          className="h-max w-full flex flex-col flex-grow-1 justify-start space-y-4 mb-48 pt-24 px-6  bg-slate-800 text-center text-slate-300  md:px-24 md:text-left lg:pl-64"
        >
          <div
