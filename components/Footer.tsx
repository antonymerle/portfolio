...
const social = [
  {
    name: "GitHub",
    href: "https://github.com/antonymerle/hyproom-frontend",
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/hyproom_workspaces/",
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  return (
    <footer className="flex flex-col space-y-12 justify-center items-center h-[777px] text-slate-300">
      ...
      <ul className="flex flex-row space-x-6 md:space-x-10">
        {social.map((item, i) => (
          <li key={i}>
            <a href={item.href} target="blank" aria-label={item.name}>
